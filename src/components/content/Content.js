...
const Content = ({ sidebarIsOpen, toggleSidebar }) => (
  ...
  >
    ...
    <Switch>
      ...
      <Route exact path="/Uploads" component={() => 
        <div>
           <Navbar/>           
        </div>
      } />
      ...
      />
      <Route exact path ="/placementdashboardmore" component={()=>
      <div>
        <PlacementTrainingmore/>
      </div>
      }
      />
      <Route exact path="/TrainingBoardEdit" component={()=>
      <div>
        <TrainingBoardEdit/>
      </div>
    }
    />
      <Route exact path="/PlacementEditBoard" component={()=>
      <div>
        <PlacementBoardEdit/>
      </div>
    }
    />
    <Route exact path="/Uploads/users" component={()=>
      <div>
        <Users/>
      </div>
  }/>

    ...
    <div class="container-fluid">
      <Card className="Rounded p-3">
                ...
                <hr></hr>
                  <RadarExample2/>
                  <br></br>
                  <Button onClick={()=>{this.handleModalamcat()}}>Edit</Button>
                  <Modal show={this.state.show} onHide={()=>this.handleModalamcat()} size="lg" style={{maxWidth: '1600px', width: '80%'}}>
                    ...
                    <Modal.Body>
                      <form>
                        ...
                        <tr>
                            <td>
                              <input type="text" name="Logical" style={{width:"50px"}} />
                            </td>
                            <td>
                            ...
                            <td>
                              <input type="text" name="Automata" style={{width:"50px"}}/>
                            </td>
                            <td>
                              <input type="text" name="Automata_Fix" style={{width:"50px"}} />
                            </td>
                            <td>
                              <input type="text" name="Domain_1" style={{width:"50px"}}/>
                            </td>
                            <td>
                              <input type="text" name="Domain_2" style={{width:"50px"}} />
                            </td>
                          </tr>
                        </tbody>
                        </Table>

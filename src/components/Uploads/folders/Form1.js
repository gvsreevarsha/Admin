...
<Form.Group as={Row} controlId='Permanent address' style={style.btn} >
         <Form.Label style={style.label} column lg="4">
         Permanent address:
        </Form.Label>
                                    <Col lg="8">
...
<Form.Group as={Row} controlId='Father Occupation' style={style.btn} >
         <Form.Label style={style.label} column lg="4">
         Father Occupation:
        </Form.Label>
                                    <Col lg="8">
...
<Form.Group as={Row} controlId='Father Contact Number' style={style.btn} >
         <Form.Label style={style.label} column lg="4">
...
<Form.Group as={Row} controlId='Mother Occupation' style={style.btn} >
         <Form.Label style={style.label} column lg="4">
         Middle name:
        </Form.Label>
                                    <Col lg="8">
...
<Form.Group as={Row} controlId='Reservation Category' style={style.btn} >
         <Form.Label style={style.label} column lg="4">
         ...
         <div style={style.div}><input style={{marginLeft:"8rem"}}  type="submit" value="Submit" /></div><br></br>
</form>
        </div>
        </div>
        </div>

...
<Form.Group as={Row} controlId='Company official website' style={style.btn} >
         <Form.Label style={style.label} column lg="4">
...
<Form.Group as={Row} controlId='Employee strength' style={style.btn} >
         <Form.Label style={style.label} column lg="4">
         Employee strength:
        </Form.Label>
                                    <Col lg="8">
...
<Form.Group as={Row} controlId='About the company' style={style.btn} >
         <Form.Label style={style.label} column lg="4">
         About the company:
        </Form.Label>
                                    <Col lg="8">
...
<Form.Group as={Row} controlId='Techinical interviewer name' style={style.btn} >
         <Form.Label style={style.label} column lg="4">
